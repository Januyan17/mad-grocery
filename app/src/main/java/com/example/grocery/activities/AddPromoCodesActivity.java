...
public class AddPromoCodesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get promo id from intent for update
        ...
        //handle clicks, add promotion code to firebase db
    ...
    private void datePickDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int year, int monthOfYear, int dayOfMonth) {
                ...
                String pYear = ""+year;
                String pDate = pDay +"/" +pMonth +"/" +pYear; //e.g. 20/09/2021
    ...
    private void updateDataToDb() {
        ...
        //init db reference Users > Current User > Promotions > PromoID > Promo Date
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Users");
        ref.child(firebaseAuth.getUid()).child("Promotions").child(promoId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(AddPromoCodesActivity.this, "Updated...", Toast.LENGTH_SHORT).show();
                        clearData();
                    }
                })
    ...
    private void clearData() {
        //clear data after uploading code
